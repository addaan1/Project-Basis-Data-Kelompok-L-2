...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="main-card animate-fade-in">
        ...
        <div class="card-header-custom d-flex align-items-center justify-content-between">
            <h2 class="text-white mb-0 font-weight-bold d-flex align-items-center" style="font-family: 'Poppins', sans-serif;">
                <i class="fas fa-box-open me-3 text-warning fa-lg"></i>
                {{ $product->nama_produk }}
            </h2>
            <a href="{{ route('market.index') }}" class="btn-back-custom fw-bold shadow-sm">
            ...
            <div class="row">
                    ...
                    <div class="glass-panel p-3 mb-4">
                        @if($product->foto)
                            <div class="image-wrapper">
                                <img src="{{ asset('storage/' . $product->foto) }}" alt="{{ $product->nama_produk }}" class="product-detail-image">
                            </div>
                        @else
                    ...
                    <div class="action-area">
                        @if(auth()->check())
                            @if(auth()->user()->peran == 'admin')
                                <div class="glass-panel p-3">
                                    <h6 class="text-warning mb-3 border-bottom border-warning pb-2 fw-bold"><i class="fas fa-cog me-2"></i>Admin Actions</h6>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('market.edit', $product->id_produk) }}" class="btn btn-warning flex-fill fw-bold shadow-hover">
                                            <i class="fas fa-edit me-1"></i>Edit
                                        </a>
                                        <button class="btn btn-danger flex-fill fw-bold shadow-hover" onclick="confirmDelete({{ $product->id_produk }})">
                            ...
                            @elseif(auth()->user()->peran == 'petani')
                                <div class="glass-panel p-3 text-center">
                                    ...
                                    <a href="{{ route('market.index') }}" class="btn btn-warning w-100 fw-bold shadow-hover text-dark">
                            ...
                            @elseif(auth()->user()->peran == 'pengepul')
                                <div class="glass-panel p-4">
                                    <h5 class="text-warning mb-3 font-bold border-bottom border-warning pb-2"><i class="fas fa-shopping-cart me-2"></i>Beli Langsung</h5>
                                    <form method="POST" action="{{ route('market.buy', ['market' => $product->id_produk]) }}">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text glass-addon text-warning fw-bold">kg</span>
                                            </div>
                                        ...
                                        <div class="total-preview bg-white/10 p-3 rounded mb-3 border border-white-50">
                                            ...
                                            <h4 class="text-warning mb-0 font-weight-bold">Rp <span id="totalHarga">0</span></h4>
                                        </div>

                                        <button type="submit" class="btn-action-primary w-100 mb-3 shadow-hover">
                                    ...
                                    <button class="btn-action-secondary w-100 shadow-hover" onclick="openNegotiation({{ $product->id_produk }})">
                                        <i class="fas fa-comments me-2 text-warning"></i>Negosiasi Harga
                                    </button>
                                </div>
                            ...
                            @elseif(auth()->user()->peran == 'distributor')
                                <div class="glass-panel p-4 text-center">
                                    ...
                                    <a href="{{ route('market.pengepul') }}" class="btn btn-outline-warning btn-sm fw-bold">
                        ...
                        @else
                            <div class="glass-panel p-4 text-center">
                                ...
                                <a href="{{ route('login') }}" class="btn btn-warning w-100 fw-bold text-dark shadow-hover">Login Sekarang</a>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-7">
                    <div class="glass-panel h-100 p-4">
                        <h4 class="text-warning mb-4 border-bottom border-warning pb-2 fw-bold" style="letter-spacing: 0.5px;">Detail Informasi</h4>
                        
                        <div class="info-grid">
                            <div class="info-item">
                                <div class="icon-box bg-white text-success"><i class="fas fa-tag"></i></div>
                                <div class="content">
                            ...
                            <div class="info-item">
                                <div class="icon-box bg-white text-warning"><i class="fas fa-coins"></i></div>
                                <div class="content">
                            ...
                            <div class="info-item">
                                <div class="icon-box bg-white text-primary"><i class="fas fa-user"></i></div>
                                <div class="content">
                                    <label>Petani</label>
                            ...
                            <div class="info-item">
                                <div class="icon-box bg-white text-danger"><i class="fas fa-map-marker-alt"></i></div>
                                <div class="content">
                            ...
                            <div class="info-item">
                                <div class="icon-box bg-white text-secondary"><i class="fas fa-warehouse"></i></div>
                                <div class="content">
                                    <label>Stok Tersedia</label>
                                    <span class="text-warning fw-bold">{{ $product->stok }} kg</span>
                                </div>
                            </div>
                        </div>

                        <div class="mt-4 pt-3 border-top border-white-50">
                            <h6 class="text-warning mb-2 fw-bold"><i class="fas fa-align-left me-2"></i>Deskripsi Produk</h6>
                            <p class="text-white leading-relaxed ps-4 border-start border-warning border-3" style="text-align: justify; opacity: 0.9;">
                                {{ $product->deskripsi }}
                            </p>
                        </div>
